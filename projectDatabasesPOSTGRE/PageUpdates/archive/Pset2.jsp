...
<c:if test="${fn:startsWith(par1.key, 'go')}"> 
<sql:update var="input" dataSource="${jdbc}">
...
<tr><td><input type="checkbox" name="go${extRow.pmid}" value="${extRow.pmid}" ></td>
<td> 
<a href="profile.jsp?name=<c:out value="${extRow.pmid }"/>"><c:out value="${extRow.title }"/></a> by 
