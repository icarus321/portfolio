...
$sql5="INSERT INTO Reviews(Comments, ISBNR) VALUES ('$n','$m')";
$result5 = mysqli_query($con,$sql5);
$recentID = mysqli_insert_id($con);
$recentID2 = $recentID;
$sql6="INSERT INTO HaveReviews(ReviewIdHaveReviews,IsbnHaveReviews) VALUES ('$recentID2','$m')";
$result6 = mysqli_query($con,$sql6);
$sql7="INSERT INTO Writes(UserNameWrites,ReviewWrites) VALUES ('$q','$recentID2')";
